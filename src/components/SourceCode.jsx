// college-notes-site/src/components/SourceCode.jsx
import React, { useEffect, useState } from "react";

const API_KEY = "AIzaSyDfKfLsU9sTuS4ftcRh1Rxk_j4K860vbFs";
const SOURCE_FOLDER_ID = "14BlhgZC6S7wQVl-GfGh3ldjAIi2F3OQQ"; // Replace with your folder ID
...
function SourceCode() {
  ...
  useEffect(() => {
    fetch(
      `https://www.googleapis.com/drive/v3/files?q='${SOURCE_FOLDER_ID}'+in+parents+and+mimeType='application/vnd.google-apps.folder'&key=${API_KEY}`
    )
      .then((res) => res.json())
      .then((data) => {
